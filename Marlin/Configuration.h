...
#define STRING_CONFIG_H_AUTHOR "(Derek Chauran, original QQ-S work by Anders Sahlman)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FLSUN QQ-S, SKR Mini E3"
...
#define DELTA
  ...
  #define DELTA_ENDSTOP_ADJ { 0.0, -0.37, 0.72 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 142.18              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.10, -0.03, -0.08 } // Get these values from G33 auto calibrate
 ...
 */
#define Z_MIN_PROBE_PIN 44 // Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -20.5 }
