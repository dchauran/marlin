...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      220 // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   210  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT         1800  // (seconds) Time limit before the nozzle is turned off for safety.
 ...
 */
  ...
  #define Z2_HYBRID_THRESHOLD    150
  #define Z3_HYBRID_THRESHOLD    150
  #define Z4_HYBRID_THRESHOLD    150
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_2 "Probe Z"
  #define USER_GCODE_2 "G30"

  #define USER_DESC_3 "Delta Calibration"
  #define USER_GCODE_3 "G33"

  #define USER_DESC_4 "Probe state"
  #define USER_GCODE_4 "M43 44"
