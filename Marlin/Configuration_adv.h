...
#define FAN_KICKSTART_POWER 100  // 64-255
...
#define HOMING_BACKOFF_POST_MM { 2, 2, 5 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 268,  20 }, { 268, 258 }, { 20, 258 } }
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  25.95          // (Hz) The default dominant resonant frequency on the X axis.
    ...
    #define SHAPING_FREQ_Y  25.4          // (Hz) The default dominant resonant frequency on the Y axis.
  ...
  #define SHAPING_MAX_STEPRATE 12000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -3
...
#define FREEZE_FEATURE
  ...
  #define FREEZE_PIN PB2   // Override the default (KILL) pin here
